...
mixin _$BookEntity {
 ...
 int get id; String get title; String get author; String get url; int get languageId;
...
@override
int get hashCode => Object.hash(runtimeType,id,title,author,url,languageId);

@override
String toString() {
  return 'BookEntity(id: $id, title: $title, author: $author, url: $url, languageId: $languageId)';
}
...
@useResult
$Res call({
 int id, String title, String author, String url, int languageId
});
...
/// Create a copy of BookEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? author = null,Object? url = null,Object? languageId = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String title,  String author,  String url,  int languageId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BookEntity() when $default != null:
return $default(_that.id,_that.title,_that.author,_that.url,_that.languageId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String title,  String author,  String url,  int languageId)  $default,) {final _that = this;
switch (_that) {
case _BookEntity():
return $default(_that.id,_that.title,_that.author,_that.url,_that.languageId);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String title,  String author,  String url,  int languageId)?  $default,) {final _that = this;
switch (_that) {
case _BookEntity() when $default != null:
return $default(_that.id,_that.title,_that.author,_that.url,_that.languageId);case _:
  return null;
...
class _BookEntity implements BookEntity {
  const _BookEntity({required this.id, required this.title, required this.author, required this.url, required this.languageId});
...
/// Create a copy of BookEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? author = null,Object? url = null,Object? languageId = null,}) {
